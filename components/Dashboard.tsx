...
export const Dashboard: React.FC<DashboardProps> = ({ leads }) => {
  const stats = {
    ...
    genuine: leads.filter(l => {
      console.log('Lead quality after fix:', l.leadQuality, 'Type:', typeof l.leadQuality);
      return l.leadQuality === 'Genuine' || l.leadQuality === 'HOT' || l.leadQuality === LeadCategory.HOT;
    }).length,
